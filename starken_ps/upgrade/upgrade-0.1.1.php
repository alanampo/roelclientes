...
function upgrade_module_0_1_1()
{
    Configuration::deleteByName('SWASTARKENCL_CARRIER_ID');
    Configuration::deleteByName('SWASTARKENCL_SERVICE_SELECTED');
    Configuration::deleteByName('SWASTARKENCL_DELIVERY_SELECTED');
