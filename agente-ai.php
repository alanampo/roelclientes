  ...
  <style>
    ...
    * {
    ...
    .start {
      padding: 14px 18px;
      border-radius: 14px;
      background: linear-gradient(180deg, rgba(34, 211, 238, .15), rgba(0, 0, 0, .3));
...
<body>
  <div class="topbar">
    <a href="inicio.php" class="chip"
      style="background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.15);text-decoration:none;display:inline-flex;align-items:center;gap:6px">
      ← Volver
    </a>
    <div style="display:flex;align-items:center;gap:10px">
      <div
        style="width:18px;height:18px;border-radius:50%;background:conic-gradient(from 0deg,#22d3ee,#14b8a6,#0ea5e9,#22d3ee);box-shadow:0 0 14px #22d3ee">
      </div>
      <strong>Roelplant · Avatar Asesor</strong>
    </div>
    <div style="margin-left:auto;display:flex;align-items:center;gap:12px">
      <span id="userDisplay" style="font-size:13px;color:#bcd0e6"></span>
      <button id="btnProfile" class="chip"
        style="display:none;background:rgba(34,211,238,.14);border-color:rgba(34,211,238,.35)">👤 Mi Perfil</button>
      <button id="btnLogout" class="chip"
        style="display:none;background:rgba(239,68,68,.2);border-color:rgba(239,68,68,.4);color:#fca5a5">Cerrar
        sesión</button>
    </div>
  </div>
  ...
  <div class="stage">
    <section class="pane left">
      <h3>Imágenes referenciadas</h3>
      <div class="feed" id="images"></div>
    </section>

    <section class="pane center">
      <div class="hud">
        <span class="chip" id="btnIniciar">Iniciar</span>
        <span class="chip" id="btnReactivar"
  ...
  <div class="overlay" id="overlay"><button class="start" id="startBig">Toca para iniciar y activar sonido</button>
  </div>
    ...
    <div class="profile-box">
      ...
      <form class="profile-form" id="profileForm">
        ...
        <div class="profile-group">
          ...
          <textarea id="profileDomicilio" name="domicilio" required
            placeholder="Calle, número, depto/oficina"></textarea>
        </div>
        <div class="profile-group">
          <label for="profileDomicilio2">Domicilio de Envío <span class="profile-required">*</span></label>
          <div style="display:flex;gap:8px;align-items:start">
            <textarea id="profileDomicilio2" name="domicilio2" required
              placeholder="Dirección de entrega para tus pedidos" style="flex:1"></textarea>
            <button type="button" id="btnCopyDomicilio" class="profile-btn"
              style="padding:10px;min-height:auto;background:rgba(34,211,238,.2);border:1px solid rgba(34,211,238,.4);color:#22d3ee;font-size:12px"
              title="Copiar domicilio principal">📋</button>
          </div>
        </div>
        <div class="profile-group">
        ...
        dc.onopen = () => {
          ...
          dc.send(JSON.stringify({
            type: 'session.update', session: {
              voice: 'alloy', instructions: SYSTEM_PROMPT, tools: [
                ...
                {
                  type: 'function', name: 'carrito_operar', parameters: {
