...
<h2>Packs Interior</h2>
<div class="catalogo">
    <?php render_catalogo($packs_interior); ?>
</div>

<h2>Packs Exterior</h2>
<div class="catalogo">
    <?php render_catalogo($packs_exterior); ?>
</div>

<h2>In-Vitro Interior</h2>
<div class="catalogo">
    <?php render_catalogo($invitro_interior); ?>
</div>
