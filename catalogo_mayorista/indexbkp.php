...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PKRXTP4L"
...
<div style="max-width: 900px; margin: 40px auto; padding: 22px; background-color: #fffbe6; border: 2px dashed #f39c12; border-radius: 12px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #555; line-height: 1.55;">
  ...
  <p><strong>Mayorista:</strong> Desde <strong>100 plantines</strong>. Envíos a todo Chile. Pagos <strong>previos al despacho</strong>. Revisa nuestros
    <a href="https://roelplant.cl/terminos/" target="_blank" rel="noopener">Términos y Condiciones</a>.
  </p>

  <p><strong>Producción a pedido:</strong> Coordinación de <strong>tiempos</strong> y <strong>cantidades</strong> con el equipo de ventas. Solicítalo aquí:
  ...
  <ul style="padding-left: 18px; margin: 14px 0;">
    ...
    <li><strong>Contacto ventas:</strong> WhatsApp <a href="https://wa.me/56933217944" target="_blank" rel="noopener">+56 9 3321 7944</a> <a href="https://wa.me/56984226651" target="_blank" rel="noopener">+56 9 8422 6651</a>· Instagram <a href="https://instagram.com/roelplant" target="_blank" rel="noopener">@roelplant</a></li>
  </ul>
...
// Integra con tu función existente (solo añade la última línea)
const _openProductoModal = window.openProductoModal;
window.openProductoModal = function(card){
  _openProductoModal(card);    // llama a tu versión actual
...
(function(){
  ...
  const fire = (p)=>{
    [25,50,75,100].forEach(t=>{
      if(!sent[t] && p>=t){ sent[t]=true; dl({event:'scroll_depth', percent:t}); }
    });
  };
  const onScroll = ()=>{
  ...
  const thr = (fn, wait)=>{ let t=0; return ()=>{ const n=Date.now(); if(n-t>wait){ t=n; fn(); }}};
