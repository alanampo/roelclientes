...
// Reglas mayoristas: mínimo 50 unidades por especie (o 0 para eliminar, pero aquí no aplica).
if ($qty < 50) bad_request('Mínimo 50 unidades por especie.');

$ins = $db->prepare("INSERT INTO cart_items_may (cart_id, id_variedad, referencia, nombre, imagen_url, unit_price_clp, qty)
VALUES (?,?,?,?,?,?,?)
